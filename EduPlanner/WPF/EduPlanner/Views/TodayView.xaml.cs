...
namespace EduPlanner.Views
{
    ...
    public partial class TodayView : UserControl
    {
        ...
        public string txtWelcome => string.Format("Hello, {0}. Today is {1}, {2} {3}, {4}.", Environment.UserName, DateTime.Now.DayOfWeek, DateTime.Now.ToString("MMMM"), DateTime.Today.Day, DateTime.Now.Year);
